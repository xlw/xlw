...
{
    public class AssemblyFinderGenerator
    {
        public static void WriteAssemblyFinder(string  theFileName)
        {
            IO.StreamWriter assemblyFinder = IO.File.CreateText(theFileName);
            string theSource = @" 
/*
...
*/
        ...
        namespace 
        {
          AssembleyFinderInitialiser theFinder;
            ...
            assemblyFinder.Write(theSource);
            assemblyFinder.Close();
