...
{
    public class ObjectCache : Singleton<Dictionary<string,CellMatrix>>
    {
    }

    public class NumberCache : Singleton<Dictionary<string, int>>
    {
    }

    public class DiscountCurveCache : Singleton<Dictionary<string, MyMatrix>>
    {
