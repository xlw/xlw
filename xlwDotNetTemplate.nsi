...
Function ExtractorPage
	...
	${NSD_CreateRadioButton} 40 0 100% 10% "Visual C# 2010 (VS10)"
	Pop $VS10_CSHARP
	nsDialogs::OnClick  $VS10_CSHARP $0
	
	${NSD_CreateRadioButton} 40 25 100% 10% "Visual C# 2008 (VS9)"
	Pop $VS9_CSHARP
	nsDialogs::OnClick  $VS9_CSHARP $0
	
    ${NSD_CreateRadioButton} 40 50 100% 10% "Visual C# 2005 (VS8)"
	Pop $VS8_CSHARP
	nsDialogs::OnClick  $VS8_CSHARP $0
	
    ${NSD_CreateRadioButton} 40 75 100% 10% "Visual F# 2010 (VS10)"
	Pop $VS10_FSHARP
