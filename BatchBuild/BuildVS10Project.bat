...
%NET4BUILD% /p:Configuration=Debug:Platform=x86 /t:rebuild  %1  >> "%LOG_ROOT%x86-Debug.log" 2>&1 
%NET4BUILD% /p:Configuration=Release:Platform=x86 /t:rebuild  %1  >> "%LOG_ROOT%x86-Release.log" 2>&1 
