...
"C:\WINDOWS\Microsoft.NET\Framework\v3.5\MSBuild"   ..\xlwDotNet\Example\VS8\Example.sln /t:rebuild  /property:Configuration=Release >> xlwDotNetExample_Release_8.log 2>&1 
