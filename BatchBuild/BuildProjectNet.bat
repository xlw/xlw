...
@if exist "%~1\VS11" for %%f in ("%~1\VS10\*.sln") do CALL BuildVS10Project.bat "%%f" %2 NET
...
@if exist "%~1\VS11_PRO" for %%f in ("%~1\VS10_PRO\*.sln") do CALL BuildVS11Project.bat "%%f" %2 NET
