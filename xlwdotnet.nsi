	...
	!define DEV_OR_RELEASE "- This is a development version"  ; uncomment on development version
...
SubSection "xlw" xlw
	...
	SectionGroup "Libraries" Libraries
		...
		Section "VS2003"  VS2003
			...
			!insertmacro projectfiles "xlw\Template Projects\vc7"
			!insertmacro sourcefiles  "xlw\Template Projects\vc7"
		SectionEnd
		...
		Section "VS2005" VS2005
			...
			!insertmacro projectfiles "xlw\Template Projects\vc8"
			!insertmacro sourcefiles  "xlw\Template Projects\vc8"
		SectionEnd
		...
		Section "VS2008" VS2008
			...
			File "xlw\lib\xlw-vc80*.pdb"
			!insertmacro projectfiles "xlw\Template Projects\vc9"
			!insertmacro sourcefiles  "xlw\Template Projects\vc9"
		SectionEnd
		...
		Section "Dev-C++" DEVCPP
			...
			File "xlw\lib\xlw-vc80*.pdb"
			!insertmacro projectfiles "xlw\Template Projects\devcpp"
			!insertmacro sourcefiles  "xlw\Template Projects\devcpp"
		SectionEnd
		
		Section "Code::Blocks(mingw)" CODEBLOCKS
			SetOutPath "$INSTDIR\xlw\lib"
			File  "xlw\lib\libxlw-gcc*.a"
			!insertmacro projectfiles "xlw\Template Projects\codeblocks-gcc"
			!insertmacro sourcefiles  "xlw\Template Projects\codeblocks-gcc"
		SectionEnd
		
		Section "make(mingw)" GCCMAKE
			SetOutPath "$INSTDIR\xlw\lib"
			File  "xlw\lib\libxlw-gcc*.a"
			!insertmacro projectfiles "xlw\Template Projects\gcc-make"
			!insertmacro sourcefiles  "xlw\Template Projects\gcc-make"
		SectionEnd
	...
	Section "Examples"
		...
		!insertmacro doExample "xlw\examples\AutoGenerated"
...
SubSection "xlwDotNet" xlwDotNet
	...
	SectionGroup "Libraries" xlwDotNetLibraries
		...
		Section "VS2005" VS2005DotNet
			...
			!insertmacro projectfiles "xlwDotNet\Template Projects\VS8"
			!insertmacro sourcefiles  "xlwDotNet\Template Projects\VS8"
			${If} VS2005PRO_CSharp_INST != ""  
				!insertmacro projectfiles "xlwDotNet\Template Projects\Hybrid_Cpp_CSharp_XLLs\VS8_PRO"
				!insertmacro sourcefiles  "xlwDotNet\Template Projects\Hybrid_Cpp_CSharp_XLLs\VS8_PRO"
			${EndIf}
		...
		Section "VS2008" VS2008DotNet
			...
			!insertmacro projectfiles "xlwDotNet\Template Projects\VS9"
			!insertmacro sourcefiles  "xlwDotNet\Template Projects\VS9"
			${If} VS2008PRO_CSharp_INST != ""  
				!insertmacro projectfiles "xlwDotNet\Template Projects\Hybrid_Cpp_CSharp_XLLs\VS9_PRO"
				!insertmacro sourcefiles  "xlwDotNet\Template Projects\Hybrid_Cpp_CSharp_XLLs\VS9_PRO"
			${EndIf}
		SectionEnd
